...
finder = BigramCollocationFinder.from_words(
    words, window_size = 7)
output = finder.nbest(bigram_measures.likelihood_ratio, 5000)
...
output_file.close()
output = finder.nbest(bigram_measures.pmi, 5000)
save_path = 'D:\Dropbox\ILS890\collocation_result'
...
for words in output:
    output_file.write( '\t '.join(words)+'\n')
output_file.close()
output = finder.nbest(bigram_measures.student_t, 5000)
save_path = 'D:\Dropbox\ILS890\collocation_result'
...
for words in output:
    output_file.write( '\t '.join(words)+'\n')
output_file.close()
output = finder.nbest(bigram_measures.chi_sq, 5000)
save_path = 'D:\Dropbox\ILS890\collocation_result'
